            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative">
                <div className="rounded-2xl border border-[#E8855A]/20 bg-[#E8855A]/[0.04] p-8 overflow-hidden">
                  ...
                  <div className="font-mono text-[10px] tracking-[0.14em] uppercase text-[#E8855A]/60 mb-6">{h.moduleLabel}</div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <Btn href={lp('/proof-of-meal')} variant="primary">{t.common.learnMore}</Btn>
                  <Btn href={lp('/meal')} variant="ghost">{h.porMealCta}</Btn>
                </div>
              </div>
            </div>
          </Section>
