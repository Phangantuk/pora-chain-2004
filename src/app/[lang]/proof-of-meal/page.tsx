...
const VERIFICATION_STEPS = [
  ...
  },
  {
    ...
    desc:  'Two independent validators review the submission against the Proof of Meal standards. Both must approve for the event to proceed.',
  },
  {
    num:   '03',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-[15px] text-ink-secondary leading-[1.75] mb-5 font-light">
              Proof of Meal verifies real-world feeding events. An organization or individual serves meals to people in need, documents the event with evidence, and submits it to the PORA protocol for verification.
            </p>
            <p className="text-[15px] text-ink-secondary leading-[1.75] mb-5 font-light">
